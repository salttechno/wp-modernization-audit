...
### Include Core Web Vitals (PageSpeed Insights)

```bash
wp-modernization-audit \
  --url https://example.com \
  --ps-api-key YOUR_API_KEY
```

> **Note:** Obtaining a PageSpeed API key allows the tool to fetch real-world performance metrics (LCP, CLS, INP).
